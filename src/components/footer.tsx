  ...
  ({ className, ...props }, ref) => {
    return (
      <footer
        ...
        ref={ref}
        className={cn(
          `flex flex-col items-center justify-center gap-2 bg-neutral-900 px-4 py-12 text-center text-xs text-neutral-500 dark:bg-neutral-950`,
          className,
        )}
      >
        <Image
        ...
        <p>Last updated: 26th March 2024</p>
